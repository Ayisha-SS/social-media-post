  ...
  return (
    ...
    <Helmet>
      ...
      <div className='wrapper py-16 '>
        <div className='flex flex-col py-2 w-full items-start h-auto border-4 border-white p-2'>
...
//           // Handle any specific fields that might conflict or need special handling
//           title: postResponse.data.title || createPostResponse.data.title,
//           description: postResponse.data.description || createPostResponse.data.description,
//           image: postResponse.data.image || createPostResponse.data.image,
//           created_by: postResponse.data.created_by || createPostResponse.data.created_by,
//           category: postResponse.data.category || createPostResponse.data.category,
//         };
...
//   if (error) {
//     return <div>Error fetching the post: {error.message}</div>;
//   }
...
//         <title>PostFun | View</title>
//       </Helmet>
//       <div className='py-4 border-b border-b-solid border-b-purple-500 shadow-2xl'>
//         <div className='wrapper'>
//           <Logo />
//         </div>
//       </div>
